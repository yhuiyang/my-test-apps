...
vbasic/  - Visual Basic examples
xml/     - XML script examples for use with Control Center


Instructions
------------
Each individual examples directory has a README.txt which genearlly
...
The C and Python examples include all of the following modules,

...
/**
 * This class is an extendable array implementation for the primitive 
 * type <code>int</code>. 
 *
...
public class IntArray {
     ...
     * <code>size</code> elements. Please note that, the size of the
     * created array is still 0.
     * 
    ...
    /**
     * Empties the elements in this array. After clearing, the size 
     * of this <code>IntArray</code> will be "0".
     */
    public void clear() {
        this.size = 0;
    }
    ...
    /**
     * Appends one elements to the tail of the <code>IntArray</code>.
     * After this operation, the size of the <code>IntArray</code> 
    ...
    /**
     * Sets the size of this <code>IntArray</code>. If the new size
     * is greater than the current size, the new added elements will 
     * be all initialized as "0". If the new size is smaller than 
     * the current size, the tail elements will be truncated. 
     * 
     * @param size the new size of this <code>IntArray</code>
    ...
    /**
     * Converts the content into a traditional <code>int</code> 
     * array.
     * 

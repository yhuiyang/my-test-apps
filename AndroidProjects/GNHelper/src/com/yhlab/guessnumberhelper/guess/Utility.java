...
public class Utility {
    ...
    /**
     * <p>Get the label of the given candidate and guess. The label 
     * is the relation ship between the guess and the candidate. 
     * Those digits appear in both numbers and in the same position 
     * is named as "A" and those appear in both numbers but in 
     * different position is named "B". The label is the number of
     * "A"s and "B"s between a guess and a candidate.</p> 
     * 
     * <p>For example, the label of "0123" and "0135" is "2A1B" 
     * (2A: 0 and 1, 1B: 3). The value of label is in HEX formated. 
     * For example, if the label is "1A2B", the returned value will 
     * be 0x12. 
     * 
     * @param candidate the candidate
     * @param guess the guess
     * @param digitCount the number of digits in the game
     * @return the label between the given candidate and the given 
     *      guess
     */
    public static int 
    ...
    /**
     * Generates all the candidate numbers in the game of the given 
     * digit count. If the digit count is 4, the size of the 
     * returned array will be P(10,4) = 5040.
     * 
     * @param digitCount the number of digits in the game
    ...
    /**
     * Gets the bit mask of the given number. The bit mask will show
     * which digits are used in the given number. For example,
     * the bit mask of number "1357" will be 1010101(in binary), 
     * i.e, 0x55 (in HEX).
     * 
     * @param number the value to be calculated
     * @param digitCount the number of digits in the game
    ...
    /**
     * Radomizes the sub content of the given array. The range of the 
     * array to be randomized is started from the given offset for 
     * the given length.  
     * 
     * @param a the array whose content will be randomized
     * @param offset the start point of the range to be randomized
     * @param length the length of the the range to be randomized
     * @param random the random variable used
     */
    ...
    /**
     * Randomizes the whole content of the given array. This 
     * function is equivalent to <blockquote><pre>
     ...
     * @param i the index of the first swapped element
     * @param j the index of the second swapped element
     */

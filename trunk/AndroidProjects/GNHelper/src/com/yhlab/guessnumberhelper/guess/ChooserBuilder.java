...
/**
 * Provides the interface to create a new instance of 
 * <code>GuessChooser</code>. Users can create different types of 
 * builders to create different types of <code>GuessChooser<code>.
...
public interface ChooserBuilder {
    ...
    /**
     * Builds a new instance of <code>GuessChooser</code>. The 
     * instance is created based on the builder and the the given 
     * arguments.  
     *  
     * @param argv the arguments to build the chooser

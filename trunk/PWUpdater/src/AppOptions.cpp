...
void AppOptions::DB_Init()
{
    ...
    sql << wxT("BEGIN TRANSACTION;")
        ...
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"Language\", \"en\");")
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"SaveDownloadFiles\", \"false\");")
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"DownloadFiles\", \"\");")
        ...
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"LastUsedUartPort\", \"\");")
        ...
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"UBootSPIEnd\", \"0x3ffff\");")
        ...
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"UBootEnd\", \"0x8003ffff\");")
        ...
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"KernelEnd\", \"0x802fffff\");")
        ...
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"FileSystemEnd\", \"0x80ffffff\");")
        ...
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"NotifySuccessfulSoundFile\", \"\");")
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"NotifyFailedSoundFile\", \"\");")

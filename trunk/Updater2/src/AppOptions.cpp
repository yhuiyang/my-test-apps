...
void AppOptions::Init()
{
    ...
    sql << wxT("BEGIN TRANSACTION;")
        ...
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"RecordSizePosition\", \"1\");")
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"Maximize\", \"0\");")
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"FrameX\", \"-1\");")
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"FrameY\", \"-1\");")
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"FrameW\", \"-1\");")
        << wxT("INSERT OR IGNORE INTO AppOptions VALUES (\"FrameH\", \"-1\");")
